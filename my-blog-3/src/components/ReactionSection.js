...
class ReactionSection extends Component {
    ...
    UpvoteArticle = async () => {
        ...
        const result = await fetch(`https://anuska-article-management.onrender.com/api/articles/${articleName}/upvote`, {
            method: 'post',
            headers: {
    ...
    DownvoteArticle = async () => {
        const { articleName, setArticleInfo } = this.props;
        const result = await fetch(`https://anuska-article-management.onrender.com/api/articles/${articleName}/downvote`, {
            method: 'post',
            headers: {
            'Content-Type': 'application/json'
        }
